...
def recuperar_conta_cliente(cliente):
    ...
    # FIXME: Não permite o cliente escolher contas
...
def criar_cliente(clientes):
    ...
    endereco = input("informe o enddereço (logradouro, nro - bairro - cidade/sigla estado): ")

    cliente = PessoaFisica(nome=nome,
    data_nacimento=data_de_nascimento, cpf=cpf,
    endereco=endereco)
